...
namespace cobridge_base {
    ...
    public:
        ...
        virtual void publish_parameter_values(ConnectionHandle client_handle,
        ...
        virtual void send_message(ConnectionHandle client_handle, ChannelId chan_id, uint64_t timestamp,
                                 const uint8_t *payload, size_t payload_size) = 0;

        virtual void broadcast_time(uint64_t timestamp) = 0;

        virtual void send_service_response(ConnectionHandle client_handle,
                                         const ServiceResponse &response) = 0;

        virtual void update_connection_graph(const MapOfSets &published_topics,
                                           const MapOfSets &subscribed_topics,
                                           const MapOfSets &advertised_services) = 0;

        virtual void send_fetch_asset_response(ConnectionHandle client_handle,
